...
public class DMyAdapter extends RecyclerView.Adapter<DMyAdapter.MYViewHolder> {
    ...
    int lastposition=-1;
    public DMyAdapter(int[] arr_imgs, String[] arr_names){
    ...
    public void onBindViewHolder(@NonNull MYViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v1) {
                if(position==0){
                    Intent intent1=new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.dip.rahul.ac.in/"));
                    ...
                    Intent intent1=new Intent(Intent.ACTION_VIEW, Uri.parse("https://civil.kiit.ac.in/"));
                    v1.getContext().startActivity(intent1);
                    ...
                    Intent intent1=new Intent(Intent.ACTION_VIEW, Uri.parse("https://ahduni.edu.in/academics/schools-centres/bagchi-school-of-public-health/"));
                    v1.getContext().startActivity(intent1);
                    ...
                    Intent intent1=new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.manipal.edu/sois.html"));
                    v1.getContext().startActivity(intent1);
