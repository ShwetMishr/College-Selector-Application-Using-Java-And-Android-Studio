...
public class engineering extends AppCompatActivity {
    ...
    int imgs[]={R.drawable.vit,R.drawable.galgotia,R.drawable.ic_home_black_24dp,R.drawable.ic_home_black_24dp,R.drawable.ic_home_black_24dp,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAdapter myAdapter=new MyAdapter(imgs,names);
